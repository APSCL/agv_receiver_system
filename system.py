...
# TODO: set up configuration for a better logging system
logger = logging.getLogger(__name__)

# TODO: set up normal config file for running code
# TODO: Make Topic and message handling more abstract

QOS_PROFILE = 10  # depth of which to subscribe to node history
SAMPLE_PERIOD_SECONDS = (
    2.5  # how often to recieve updates from turtle bot, and therefore write to in memeory DB
)
